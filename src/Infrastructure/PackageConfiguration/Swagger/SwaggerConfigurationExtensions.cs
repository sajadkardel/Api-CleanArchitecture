...
namespace Infrastructure.PackageConfiguration.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        ...
        public static IApplicationBuilder UseElmahCore(this IApplicationBuilder app, GeneralSettings generalSettings)
        {
            Assert.NotNull(app, nameof(app));
            Assert.NotNull(generalSettings, nameof(generalSettings));

            app.UseWhen(context => context.Request.Path.StartsWithSegments(generalSettings.ElmahPath, StringComparison.OrdinalIgnoreCase), appBuilder =>
            {
